...
public static class Runtime
{
    ...
    public static long Version { get => long.Parse(RuntimeBuildDate.Year + string.Empty + RuntimeBuildDate.Month + string.Empty + RuntimeBuildDate.Day + string.Empty + RuntimeBuildDate.Hour + string.Empty +
